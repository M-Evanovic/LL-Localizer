#ifndef _LL_LOCALIZER_POINTCLOUD_PROCESSING_H_
#define _LL_LOCALIZER_POINTCLOUD_PROCESSING_H_
...
class PointCloudPreprocess {
   public:
    ...
    // accessors
    double &Blind() { return blind; }
    int &NumScans() { return num_scans; }
    int &PointFilterNum() { return point_filter_num; }
    bool &FeatureEnabled() { return feature_enabled; }
    float &TimeScale() { return time_scale; }
    LidarType GetLidarType() const { return lidar_type; }
    void SetLidarType(LidarType lt) { lidar_type = lt; }
   ...
   private:
    ...
    PointCloudType cloud_full, cloud_out;
