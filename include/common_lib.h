...
using Pose6D = ll_localizer::Pose6D;
...
struct MeasureGroup {
    MeasureGroup() { this->lidar.reset(new PointCloudType()); };

    double lidar_bag_time = 0;
    double lidar_end_time = 0;
    PointCloudType::Ptr lidar = nullptr;
